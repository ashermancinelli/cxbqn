 ...
 * Generated by the CXBQN build system on 2021-11-11T11:30:28
 */
...
TEST_CASE("\"abc\"≡0⊑\"abc\"‿\"de\"") {
  ...
  CompileParams p{{0, 3, 0, 4, 11, 2, 0, 1, 0, 2, 17, 0, 0, 0, 3, 17, 7},
                  {runtime[18], runtime[36], 0, std::make_shared<Array>(U"abc"),
...
TEST_CASE("\"de\"≡1⊑\"abc\"‿\"de\"") {
  ...
  CompileParams p{{0, 4, 0, 3, 11, 2, 0, 1, 0, 2, 17, 0, 0, 0, 3, 17, 7},
                  {runtime[18], runtime[36], 1, std::make_shared<Array>(U"de"),
                   std::make_shared<Array>(U"abc")},
                  {{0, 1, 0}},
                  {{0, 0}}};
...
TEST_CASE("1≡'e'!1") {
  ...
  CompileParams p{
      ...
      {runtime[18], runtime[42], 1, std::make_shared<Character>(U'e')},
      {{0, 1, 0}},
      {{0, 0}}};
