 ...
 * Generated by the CXBQN build system on 2021-11-18T07:49:35
 */
...
TEST_CASE("3≡4 1◶+‿-1") {
  ...
  CompileParams p(
      ...
      {runtime[0], runtime[1], runtime[18], runtime[59], 3, 4, 1}, {{0, 1, 0}},
      {{0, 0}},
...
TEST_CASE("1≡-⊘0 ¯1") {
  ...
  CompileParams p({0, 5, 0, 4, 0, 2, 0, 0, 27, 16, 0, 1, 0, 3, 17, 7},
                  {runtime[1], runtime[18], runtime[58], 1, 0, -1}, {{0, 1, 0}},
                  {{0, 0}},
...
TEST_CASE("\"abc\"≡⊢\"abc\"") {
  ...
  CompileParams p(
      ...
      {runtime[18], runtime[21], std::make_shared<Array>(U"abc")}, {{0, 1, 0}},
      {{0, 0}},
...
TEST_CASE("⟨⟩≡⊣⟨⟩") {
  ...
  CompileParams p(
      {11, 0, 0, 1, 16, 0, 0, 11, 0, 17, 7}, {runtime[18], runtime[20]},
      {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("4≡+˜2") {
  ...
  CompileParams p({0, 4, 0, 2, 0, 0, 26, 16, 0, 1, 0, 3, 17, 7},
                  {runtime[0], runtime[18], runtime[45], 4, 2}, {{0, 1, 0}},
                  {{0, 0}},
...
TEST_CASE("3≡1-˜4") {
  ...
  CompileParams p({0, 5, 0, 2, 0, 0, 26, 0, 4, 17, 0, 1, 0, 3, 17, 7},
                  {runtime[1], runtime[18], runtime[45], 3, 1, 4}, {{0, 1, 0}},
                  {{0, 0}},
...
TEST_CASE("20≡×⟜(-⟜1)5") {
  ...
  CompileParams p(
      ...
      {runtime[1], runtime[2], runtime[18], runtime[56], 20, 1, 5}, {{0, 1, 0}},
      {{0, 0}},
...
TEST_CASE("2≡√4") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[5], runtime[18], 2, 4},
      {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("3≡3√27") {
  ...
  CompileParams p({0, 3, 0, 0, 0, 2, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[5], runtime[18], 3, 27}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("6≡2∧3") {
  ...
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[10], runtime[18], 6, 2, 3}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
                  std::make_shared<Array>(U"6≡2∧3"));
  auto ret = vm::run(p.bc, p.consts.v, p.blk_defs, p.bodies,
...
TEST_CASE("0≡¯2∧0") {
  ...
  CompileParams p({0, 2, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[10], runtime[18], 0, -2}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("1.75≡2∨0.25") {
  ...
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[11], runtime[18], 1.75, 2, 0.25}, {{0, 1, 0}},
                  {{0, 0}},
...
TEST_CASE("0≡¬1") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[9], runtime[18], 0, 1},
      {{0, 1, 0}}, {{0, 0}},
      {{3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}, {3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("1≡¬0") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[9], runtime[18], 1, 0},
      {{0, 1, 0}}, {{0, 0}},
      {{3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}, {3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("2≡¬¯1") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[9], runtime[18], 2, -1},
      {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("0≡3¬4") {
  ...
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[9], runtime[18], 0, 3, 4}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("2≡4¬3") {
  ...
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[9], runtime[18], 2, 4, 3}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("4≡5¬2") {
  ...
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[9], runtime[18], 4, 5, 2}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("0≡|0") {
  ...
  CompileParams p(
      {0, 2, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[8], runtime[18], 0},
      {{0, 1, 0}}, {{0, 0}},
      {{3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}, {3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("5≡|¯5") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[8], runtime[18], 5, -5},
      {{0, 1, 0}}, {{0, 0}},
      {{3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}, {4, 4, 2, 2, 2, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("6≡|6") {
  ...
  CompileParams p(
      {0, 2, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[8], runtime[18], 6},
      {{0, 1, 0}}, {{0, 0}},
      {{3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}, {3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("2≡3|8") {
  ...
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[8], runtime[18], 2, 3, 8}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("2≡3|¯7") {
  ...
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[8], runtime[18], 2, 3, -7}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {5, 5, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("¯1≡¯3|8") {
  ...
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[8], runtime[18], -1, -3, 8}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("⟨⟩≡≢<⟨2,⟨3,4⟩⟩") {
  ...
  CompileParams p(
      ...
      {runtime[12], runtime[18], runtime[19], 2, 3, 4}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("0≡4<2") {
  ...
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[12], runtime[18], 0, 4, 2}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("0≡5>5") {
  ...
  CompileParams p({0, 3, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[13], runtime[18], 0, 5}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("0≡3≥4") {
  ...
  spdlog::critical("test='{}'", "0≡3≥4");
  CompileParams p({0, 4, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[17], runtime[18], 0, 3, 4}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
                  std::make_shared<Array>(U"0≡3≥4"));
  auto ret = vm::run(p.bc, p.consts.v, p.blk_defs, p.bodies,
...
TEST_CASE("0≡≠\"\"") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7},
      {runtime[14], runtime[18], 0, std::make_shared<Array>(U"")}, {{0, 1, 0}},
      {{0, 0}},
      {{3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}, {4, 4, 2, 2, 2, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("1≡≠\"a\"") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7},
      {runtime[14], runtime[18], 1, std::make_shared<Array>(U"a")}, {{0, 1, 0}},
      {{0, 0}},
...
TEST_CASE("25≡≠↕25") {
  ...
  CompileParams p({0, 3, 0, 2, 16, 0, 0, 16, 0, 1, 0, 3, 17, 7},
                  {runtime[14], runtime[18], runtime[28], 25}, {{0, 1, 0}},
                  {{0, 0}},
...
TEST_CASE("1≡×5") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[2], runtime[18], 1, 5},
      {{0, 1, 0}}, {{0, 0}},
      {{3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}, {3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("¯1≡×¯2.5") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[2], runtime[18], -1, -2.5},
      {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("3≡3⌊4") {
  ...
  CompileParams p({0, 3, 0, 0, 0, 2, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[6], runtime[18], 3, 4}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("4≡3⌈4") {
  ...
  CompileParams p({0, 2, 0, 0, 0, 3, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[7], runtime[18], 4, 3}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("1≡1⌈¯1") {
  ...
  CompileParams p({0, 3, 0, 0, 0, 2, 17, 0, 1, 0, 2, 17, 7},
                  {runtime[7], runtime[18], 1, -1}, {{0, 1, 0}}, {{0, 0}},
                  {{4, 4, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0},
                   {5, 5, 3, 3, 2, 2, 3, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("5≡⌈4.01") {
  ...
  CompileParams p(
      {0, 3, 0, 0, 16, 0, 1, 0, 2, 17, 7}, {runtime[7], runtime[18], 5, 4.01},
      {{0, 1, 0}}, {{0, 0}},
      {{3, 3, 2, 2, 2, 1, 1, 0, 0, 1, 0}, {6, 6, 2, 2, 2, 1, 1, 0, 0, 1, 0}},
...
TEST_CASE("⟨⟩≡≢0") {
  ...
  spdlog::critical("test='{}'", "⟨⟩≡≢0");
  CompileParams p(
      {0, 2, 0, 1, 16, 0, 0, 11, 0, 17, 7}, {runtime[18], runtime[19], 0},
      {{0, 1, 0}}, {{0, 0}},
