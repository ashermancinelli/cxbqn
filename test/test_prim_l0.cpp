...
TEST_CASE("'a'≡¯2+'c'") {
  ...
  auto rcu ={0, 4, 0, 0, 0, 2, 17, 0, 1, 0, 3, 17, 7},
                  {runtime[0], runtime[18], -2,
                   std::make_shared<Character>(U'a'),
                   std::make_shared<Character>(U'c')},
                  {{0, 1, 0}},
...
TEST_CASE("1≡1=1") {
  ...
  auto rcu ={0, 2, 0, 0, 0, 2, 17, 0, 1, 0, 2, 17, 7},
...
TEST_CASE("1≡{F←+⋄f=f}") {
  ...
  auto rcu ={1,  1, 0,  2, 0, 3, 17, 7,  0, 0, 33, 0, 0,
...
TEST_CASE("0≡{F←{𝕩}⋄G←{𝕩}⋄f=g}") {
  ...
  auto rcu ={1, 1, 0,  1,  0,  2, 17, 7, 1,  2, 33, 0, 0, 48,
...
TEST_CASE("1≡{F←{𝕩}⋄f=f}") {
  ...
  auto rcu ={1,  1, 0, 1, 0, 2,  17, 7, 1,  2, 33, 0, 0, 48, 6,
...
TEST_CASE("⟨⟩≡≢<2") {
  ...
  auto rcu ={0, 3, 0, 0, 16, 0, 2, 16, 0, 1, 11, 0, 17, 7},
...
TEST_CASE("⟨6⟩≡≢⥊>\"abc\"‿\"fed\"") {
  ...
  auto rcu ={0, 5, 0,  6, 11, 2, 0, 0,  16, 0,  3, 16,
...
TEST_CASE("\"abc\"≡0⊑\"abc\"‿\"de\"") {
  ...
  auto rcu ={0, 3, 0, 4, 11, 2, 0, 1, 0, 2, 17, 0, 0, 0, 3, 17, 7},
...
TEST_CASE("\"de\"≡1⊑\"abc\"‿\"de\"") {
  ...
  auto rcu ={0, 4, 0, 3, 11, 2, 0, 1, 0, 2, 17, 0, 0, 0, 3, 17, 7},
...
TEST_CASE("⟨0⟩≡↕1") {
  ...
  const auto runtime = rt->values;
  spdlog::critical("test='{}'", "⟨0⟩≡↕1");
  auto rcu ={0, 3, 0, 1, 16, 0, 0, 0, 2, 11, 1, 17, 7},
...
TEST_CASE("⟨0,1,2,3,4,5,6⟩≡↕7") {
  ...
  auto rcu ={0, 9, 0, 1, 16, 0, 0, 0, 2,  0, 3,  0, 4,
