 ...
 * Generated by the CXBQN build system on 2021-11-22T17:38:55
 */
...
TEST_CASE("≡⟜⌽⟨⟩") {
  ...
  CompileParams p(
      ...
      {runtime[18], runtime[31], runtime[56]}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("0‿4≡/1‿0‿0‿0‿1‿0") {
  ...
  CompileParams p({0, 4, 0,  2, 0, 2, 0, 2, 0, 4,  0, 2,  11, 6,
                  ...
                  {runtime[18], runtime[33], 0, 4, 1}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("1‿1‿2≡/0‿2‿1") {
  ...
  CompileParams p(
      ...
      {runtime[18], runtime[33], 1, 2, 0}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("≡⟜/⟨⟩") {
  ...
  CompileParams p(
      {11, 0, 0, 1, 0, 2, 0, 0, 27, 16, 7},
      {runtime[18], runtime[33], runtime[56]}, {{0, 1, 0}}, {{0, 0}},
      {{3, 3, 2, 2, 1, 1, 0, 0, 1, 0, 0}, {4, 4, 2, 2, 1, 1, 0, 0, 1, 2, 0}},
      std::make_shared<Array>(U"≡⟜/⟨⟩"));
  auto ret = vm::run(p.bc, p.consts.to_arr(), p.blk_defs, p.bodies);
  REQUIRE(nullptr != ret.v);
...
TEST_CASE("3‿3‿3‿2‿2‿1≡/˜3‿2‿1") {
  ...
  CompileParams p(
      ...
      {runtime[18], runtime[33], runtime[45], 3, 2, 1}, {{0, 1, 0}}, {{0, 0}},
