 ...
 * Generated by the CXBQN build system on 2021-11-18T07:37:41
 */
...
TEST_CASE("2‿3≡>⟨<2,3⟩") {
  ...
  CompileParams p(
      ...
      {runtime[12], runtime[13], runtime[18], 2, 3}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("1‿2≡1≍2") {
  ...
  CompileParams p({0, 3, 0, 1, 0, 2, 17, 0, 0, 0, 2, 0, 3, 11, 2, 17, 7},
                  {runtime[18], runtime[24], 1, 2}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("(<0)≡≡˘0") {
  ...
  CompileParams p({0, 3, 0, 2, 0, 1, 26, 16, 0, 1, 0, 3, 0, 0, 16, 17, 7},
                  {runtime[12], runtime[18], runtime[46], 0}, {{0, 1, 0}},
                  {{0, 0}},
...
TEST_CASE("(<1)≡≡˘<0") {
  ...
  CompileParams p(
      ...
      {runtime[12], runtime[18], runtime[46], 1, 0}, {{0, 1, 0}}, {{0, 0}},
...
TEST_CASE("(-≡-⚇¯1)5") {
  ...
  CompileParams p({0, 4, 0, 3, 0, 2, 0, 0, 27, 0, 1, 0, 0, 21, 16, 7},
                  {runtime[1], runtime[18], runtime[61], -1, 5}, {{0, 1, 0}},
                  {{0, 0}},
...
TEST_CASE("(3⌊↕5)≡{i←0⋄r←{i+↩1⋄1+𝕩}⍟(↕4)𝕩⋄r∾i}0") {
  ...
  CompileParams p(
      ...
      {{0, 1, 0}, {0, 0, 1}, {0, 0, 2}}, {{0, 0}, {19, 5}, {55, 3}},
...
TEST_CASE("⟨⟩≡×`⟨⟩") {
  ...
  CompileParams p({11, 0, 0, 2, 0, 0, 26, 16, 0, 1, 11, 0, 17, 7},
                  {runtime[2], runtime[18], runtime[52]}, {{0, 1, 0}}, {{0, 0}},
